# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/3.svg" class="solvedac-tier"> [등장하지 않는 문자의 합](https://www.acmicpc.net/problem/3059) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|57220788|jbin3031|맞았습니다!! |14120KB|136ms|Java 11|1151B|
